...
public class Hero : MonoBehaviour
{
    ...
    //Create a WeaponFireDelegate even name fireEvent
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.LogWarning("Shield trigger hit by non-Ememy: " + go.name);
        }
    }
    ...
    /// </summary>
    ///<returns>The first emtpy Weapon slot or null if none are empty</returns>
