...
public class PowerUp : MonoBehaviour
{
    ...
    [Tooltip("x holds a min vlaue and y a max value for a Random.Range() call")]
    ...
    void Awake()
    {
        ...
        vel.Normalize(); // Normalizing a Vector3 set its length to lm
        ...
        // Quarternion.identity is equal to no rotation 
    ...
    void Update()
    {
        ...
        if (u > 0)
        {
            ...
            c = letter.color;
            c.a = 1f - (u*0.5f); // Set alpha of the letter to 1 - (u/2)
            letter.color = c;
        }
    ...
    ///<summary>
    ///This function is called by Hero class when a PowerUp is collected.
    /// </summary>
