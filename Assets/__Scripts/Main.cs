...
public class Main : MonoBehaviour
{
    ...
    /// </summary>
    /// <returns>The WeaponDefinition, or if there is no WeaponDefinition with the eWeaponType
    ///     passed in, returns a new WeaponDefinition with a eWeaponType of eWeaponType.none </returns>
    ...
    ///<summary>
    /// Called by an Enemy ship whenever it is destroyed. It sometimes creates a PowerUp in place of
    /// the destroyed ship.
    ///</summary>
